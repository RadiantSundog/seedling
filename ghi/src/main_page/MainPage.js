...
<div className="container text-left">
  <div className="row row-cols-3">
    ...
    <div className="col">
      <ul>
        <li><a href="https://en.wikipedia.org/wiki/Arboretum" target="_blank" rel="noopener noreferrer">Arboretum</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Bonsai" target="_blank" rel="noopener noreferrer">Bonsai</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Cultigen" target="_blank" rel="noopener noreferrer">Cultigen</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Eyecatchers" target="_blank" rel="noopener noreferrer">Eyecatchers</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Garden_writing" target="_blank" rel="noopener noreferrer">Garden writing</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Grow_bag" target="_blank" rel="noopener noreferrer">Growbag</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Introduced_species" target="_blank" rel="noopener noreferrer">Introduced species</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Impact_gardening" target="_blank" rel="noopener noreferrer">Impact gardening</a></li>
        <li><a href="https://en.wikipedia.org/wiki/List_of_gardening_topics" target="_blank" rel="noopener noreferrer">List of gardening topics</a></li>
        <li><a href="https://en.wikipedia.org/wiki/List_of_horticulture_and_gardening_books" target="_blank" rel="noopener noreferrer">List of horticulture and gardening books</a></li>
        <li><a href="https://en.wikipedia.org/wiki/List_of_professional_gardeners" target="_blank" rel="noopener noreferrer">List of professional gardeners</a></li>
        <li><a href="https://en.wikipedia.org/wiki/Master_gardener_program" target="_blank" rel="noopener noreferrer">Master gardener program</a></li>
        <li><a href="https://en.wikipedia.org/wiki/No-dig_gardening" target="_blank" rel="noopener noreferrer">No-dig gardening</a></li>
      </ul>
    </div>
  </div>
</div>
